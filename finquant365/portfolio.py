...
from finquant365.quants import weighted_mean, weighted_std, sharpe_ratio
from finquant365.returns import historical_mean_return
from finquant365.returns import daily_returns, cumulative_returns
from finquant365.returns import daily_log_returns
from finquant365.efficient_frontier import EfficientFrontier
from finquant365.monte_carlo import MonteCarloOpt
...
class Stock(object):
    ...
    def comp_expected_return(self, freq=365):
        """Computes the Expected Return of the stock.

        :Input:
         :freq: ``int`` (default: ``365``), number of trading days, default
    ...
    def comp_volatility(self, freq=365):
...
class Portfolio(object):
    ...
    def comp_mean_returns(self, freq=365):
    ...
    def comp_stock_volatility(self, freq=365):
    ...
    def mc_plot_results(self, cmap=None):
    ...
    def plot_stocks(self, freq=365):
        ...
        plt.scatter(stock_volatility, stock_returns, marker="s", s=30, color='k', label="Asset")
        ...
        for i, txt in enumerate(stock_returns.index):
            ...
            t.set_bbox(dict(facecolor='white', alpha=0.85, edgecolor='white'))
