...
import finquant365.minimise_fun as min_fun
from finquant365.quants import annualised_portfolio_quantities
...
class EfficientFrontier(object):
    ...
    def __init__(
        self, mean_returns, cov_matrix, risk_free_rate=0.042, freq=365, method="SLSQP"
    ):
        """
        :Input:
